<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DatPhong.aspx.cs" Inherits="DatPhong" %>
      ...
      <form id="form1" runat="server">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                           <nav class="linkEffects linkHoverEffect_2">
                              <ul>
                                 ...
                                 <li><a href="DatPhong.aspx" data-link-alt="Đặt phòng" class="active"><span>Đặt phòng</span></a></li>
                                 <li><a href="DichVu.aspx" data-link-alt="Service" class="scroll"><span>Dịch vụ</span></a></li>
                                 <li><a href="Home.aspx" data-link-alt="Admin" class="scroll"><span>Admin</span></a></li>
                              </ul>
                           </nav>
                        </div>
                     </nav>
         ...
         <div class="main" id="main" style="top: 22%;width: 35%;">
            <div class="w3layouts_main_grid">
               ...
               <div class="agileits_main_grid w3_agileits_main_grid">
                  <div class="wthree_grid">
                     <h5>Chọn loại phòng</h5>
                     <asp:DropDownList ID="DDL_LoaiPhong" CssClass="form-control" required="" runat="server" Width="404px" AutoPostBack="True">
                     </asp:DropDownList>
                  </div>
               </div>
               <div class="w3_agileits_main_grid w3l_main_grid">
         ...
         <!--footer-->
         <div class="footer-w3">
            <p>&copy; 2021 Website NOTE | ASP.NET</p>
         </div>
